...
const CartScreen = ({ navigation }: any) => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      console.log('📦 Cart Screen: Refreshing cart...');
      refreshCart();
    }, [refreshCart])
  );
  ...
  const handleIncrement = async (cartItemId: number) => {
    ...
    if (!result.success) {
      showToast.error(result.message || 'Failed to update quantity');
    }
  };
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            if (result.success) {
              ...
              showToast.error(result.message || 'Failed to remove item');
            }
          },
        },
      ]
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            if (result.success) {
              ...
              showToast.error(result.message || 'Failed to clear cart');
            }
          },
        },
      ]
